        ...
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 md:gap-8">
          <div className="flex gap-6 md:gap-10">
            ...
            <div>
              ...
              <p className="text-sm md:text-base text-[#929AA5] mt-4 max-w-2xl leading-relaxed">
    ...
    <section id="work" className="py-24 md:py-32 lg:py-40">
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-16 md:mb-20">
          ...
          <h2 className="text-[36px] md:text-[48px] lg:text-[64px] font-semibold tracking-tight text-[#E8EAED] leading-[1.1]">
            Things I&apos;ve built.
          </h2>
        </div>
